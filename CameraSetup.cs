...
namespace Aerolithe
{
    public partial class Aerolithe : Form
    {
        ...
        //                            if (trackBar_Gamma.InvokeRequired)
        //                            {
        //                                trackBar_Gamma.Invoke(new Action(() =>
        //                                {
        //                                    gammaValue = trackBar_Gamma.Value / 10.0f;
        //                                }));
        //                            }
        //                            else
        //                            {
        ...
        //                            if (picBox_LiveView_Main.InvokeRequired)
        //                            {
        //                                picBox_LiveView_Main.Invoke(new Action(() =>
        //                                {
        //                                    // Affichage brut
        ...
        //                            {
        //                                hScrollBar_liveMaskThresh.Invoke(new Action(() =>
        //                                {
        //                                    // Masque de luminosité
        //                                    maskBitmapLive = BrightnessMaskFromStream(stream, hScrollBar_liveMaskThresh.Value);
        //                                }));
        ...
        //                            {
        //                                safeCopy = new Bitmap(maskBitmapLive);
        //                                if (picBox_LiveView_Main.InvokeRequired)
        //                                {
        //                                    picBox_liveMaskLum.Invoke(new Action(() =>
        //                                    {
        //                                        picBox_liveMaskLum.Image = maskBitmapLive;
        //                                    }));
        //                                }
        ...
        //                                using (var maskGray = safeCopy.ToImage<Gray, byte>())
        //                                using (var resizedMask = maskGray.Resize(sourceImage.Width, sourceImage.Height, Emgu.CV.CvEnum.Inter.Linear))
        //                                {
        //                                    if (checkBox_ApplyBlur.InvokeRequired)
        //                                    {
        //                                        checkBox_ApplyBlur.Invoke(new Action(() =>
        //                                        {
        ...
        //                                        if (picBox_MLMask.InvokeRequired)
        //                                        {
        //                                            picBox_liveMaskLum.Invoke(new Action(() =>
        //                                            {
        ...
        //                                    CalculDuFlou(stream);
        //                                    CalculDuFlouFromImage(sourceImage);
        //                                    //// ❌ Calcul du flou global (désactivé)
        ...
        //                                    int blockSize = 0;
        //                                    if (trackBar_blobCount.InvokeRequired)
        //                                    {
        //                                        trackBar_blobCount.Invoke(new Action(() =>
        //                                        {
        //                                            blockSize = trackBar_blobCount.Value * 16;
        ...
        //                                            {
        //                                                trackBar_blurThreshold.Invoke(new Action(() =>
        //                                                {
        ...
        //                                    if (lbl_blobCount.InvokeRequired)
        //                                    {
        //                                        lbl_blobCount.Invoke(new Action(() =>
        //                                        {
        ...
        //                                    if (checkBox_ShowSharpnessOverlay.InvokeRequired)
        //                                    {
        //                                        checkBox_ShowSharpnessOverlay.Invoke(new Action(() =>
        //                                        {
        ...
        //                                }
        //                                if (lbl_LiveViewStreamSize.InvokeRequired)
        //                                {
        //                                    lbl_LiveViewStreamSize.Invoke(new Action(() =>
        //                                    {
